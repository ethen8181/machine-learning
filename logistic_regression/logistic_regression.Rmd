...
> All the code ("logistic_regression_code") and the data ("data" folder) can be found  [here](https://github.com/ethen8181/machine-learning/blob/master/logistic_regression).
