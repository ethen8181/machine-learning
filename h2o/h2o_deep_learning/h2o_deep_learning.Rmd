...
model_dl_2 <- h2o.deeplearning(
	...
	x = input,
	y = output,
	hidden = c( 10, 10, 10 ), # smaller network, runs faster
...
- The R code, h2o_deep_learning.R, and the sourced in function code ,h2o_deep_learning_functions.R, can be found [here](https://github.com/ethen8181/machine-learning/tree/master/h2o/h2o_deep_learning).
- Comments or issues are welcomed can be filed [here](https://github.com/ethen8181/machine-learning/issues).
...
[BestGridSearch]: https://github.com/ethen8181/machine-learning/blob/master/h2o/h2o_deep_learning/h2o_deep_learning_functions.R
