...
All the code for this documentation can be found [here](https://github.com/ethen8181/machine-learning/blob/master/linear_regression/linear_regession_code). The gradient descent function and the documentation code are in two separate scripts.

The [link](https://github.com/ethen8181/machine-learning/blob/master/linear_regression/housing.txt) to the dataset.
