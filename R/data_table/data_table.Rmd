...
> The **source of this tutorial**, including the example datasets, is available [here on GitHub](https://github.com/ethen8181/machine-learning/blob/master/R/data_table) 
...
library(knitr)
library(data.table)
setwd("/Users/ethen/machine-learning/R/data_table")
