...
- m : the number of training examples. Here we just use all `r nrow(housing)` rows.
...
$$ h_{\theta}(x) = `r comma( round(parameters[1]) )` + `r comma( round(parameters[2]) )`x_{area} + `r round(parameters[3])`x_{bedroom} $$
