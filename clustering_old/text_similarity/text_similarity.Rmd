...
> All the code text_similarity.R and data used in the documentation the data folder can be found in [this](https://github.com/ethen8181/machine-learning/blob/master/clustering_old/text_similarity) folder.  
