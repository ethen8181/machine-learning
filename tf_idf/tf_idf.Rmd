...
> This documentation assumes you are familiar with hierarchical clustering. To follow along, all the code (tf-idf.R) and the news data (news.csv) can be found [here](https://github.com/ethen8181/machine-learning/blob/master/tf_idf). 
